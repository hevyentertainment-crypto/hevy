...
export default function Preview({setPreview, artist, platforms, image, postalImage}: {setPreview: () => void, artist: Artist, platforms: Platforms, image: null | string, postalImage: File | null }) {  
