  ...
  return (
    <div className="w-screen h-screen relative">
      <div className="w-screen h-screen absolute">
          <div className="w-screen h-screen relative">
              <Image 
                src={'/images/pexels-mesut-ylcn-1233429888-29370620.jpg'}
                alt="Image"
                fill
      ...
      <div className="h-screen  absolute z-50  backdrop-blur-3xl py-6 w-screen md:py-10 md:px-32 font-sans overflow-y-scroll">
        ...
        <header className="flex justify-between items-center mb-8">
          <h1 className="text-4xl sm:text-8xl font-extrabold text-white max-sm:px-6">HEVY SOUNDS</h1>
        </header>
            ...
            <div className="flex gap-10 justify-center py-10">
                ...
                <div className="flex flex-col text-white gap-5 justify-center">
                  <div>
                    ...
                    <input className="w-full border text-white border-gray-300 bg-transparent rounded p-2 focus:ring-2 focus:ring-blue-600 outline-none" />
                  </div>

                  <div>
                    <label htmlFor="name">Song Title</label>
                    <input className="w-full border border-gray-300  text-white bg-transparent rounded p-2 focus:ring-2 focus:ring-blue-600 outline-none" />
                  </div>

                  <div>
                    <label htmlFor="name">Year of Recording</label>
                    <input type="number" className="w-full border  text-white bg-transparent border-gray-300 rounded p-2 focus:ring-2 focus:ring-blue-600 outline-none" />
                  </div>
                </div>
            </div>
          )
    ...
    <div className="flex items-center space-x-4 w-full">
      ...
      <div className="flex-1">
        ...
        <input
          ...
          className="w-full border border-gray-300 rounded p-2 focus:ring-2 focus:ring-blue-600 bg-transparent outline-none max-sm:text-white"
        />
      </div>
    </div>
  );
